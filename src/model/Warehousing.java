...
public class Warehousing {
    ...
    */
     ...
     */
    public Warehousing(String goodsDate,String goodsName,Integer goodsCategory,Integer goodsNumber){
        super();
    ...
    public Warehousing(Integer id,String goodsDate,String goodsName,Integer goodsCategory,Integer goodsNumber){
        super();
        this.id=id;
        this.goodsName=goodsName;
        this.goodsCategory=goodsCategory;
